window.onload = function () {
    ...
    // let secondaryMenuDivList = document.querySelectorAll("#secondary-menu div")
    // console.log(menuList, secondaryMenu, 333);
    // menuList.forEach((item, index) => {
    //     item.onmouseover = function () {
    //         console.log(secondaryMenu);
    //         secondaryMenuDivList.forEach((item, index) => {
    //             item.style.display = "none"
    //         })
    //         secondaryMenu.classList.add("secondary-menu-hover")
    //         secondaryMenuDivList[index].style.display = "block"
    //     }
    //     item.onmouseout = function () {
    //         secondaryMenu.classList.remove("secondary-menu-hover")
    //     }
    // })
}